...
function includedeck(m, c) {
    ...
    var info = {
        ...
        "deck-core-dependencies-requestAnimationFrame": [
            prefix + "/jquery-1.8.3.min.js",
            prefix + "/modernizr.custom.js",
            prefix + "/libs/jquery.requestAnimationFrame.min.js"
        ],
        "deck": [
        ...
        "newdeck-requestAnimationFrame": [
            "@_deck-core-dependencies-requestAnimationFrame",
	    prefix + "/extensions/style-chunks/core.css",
            prefix + "/core/deck.core.js"
        ],
        //
        ...
        "profile-2-requestAnimationFrame": ["@_newdeck-requestAnimationFrame", "@_smartsyntax", "@_fit-fs", "@_simplemath", "@_clone", "@_goto", "@_status", "@_navigation", "@_menu", "@_hash", "@_step", "@_events", "@_anim", "@_svg"],
